...
class Stream(models.Model):
    ...
    owner = models.ForeignKey(get_user_model(), on_delete=models.CASCADE, related_name="stream_set", blank=False, null=False)
    ...
    def find_whois(self):
        ...
        return asn_desc if asn_desc is not None else desc
