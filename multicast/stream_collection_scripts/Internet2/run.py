...
def run(path_to_device_file):
    BASE_URL = "https://routerproxy.net.internet2.edu/routerproxy/"
    ...
    for ip in devices:
        ...
        time.sleep(2)
        r = requests.get(BASE_URL + "?method=submit&device=" + ip + "&command=show multicast&menu=0&arguments=route extensive inet")
        time.sleep(2)
